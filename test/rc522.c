...
uchar UID[4],Temp[4];
//uchar UI0[4]={0x60,0x25,0x45,0x9A};	  //卡0ID号
//uchar UI1[4]={0xA0,0x71,0xEF,0x1B}; 	//卡1ID号
//uchar UI2[4]={0x3D,0x07,0x2D,0xF0};		//卡2ID号
uchar UI0[4]={0x00,0x00,0x00,0x00};		  //卡0ID号
uchar UI1[4]={0x00,0x00,0x00,0x00};	 		//卡1ID号
uchar UI2[4]={0x00,0x00,0x00,0x00};			//卡2ID号
uchar UI3[4]={0x00,0x00,0x00,0x00};			//卡3ID号
/****************RC522驱动源码**************************************/
